...
## total count, venn diagram
{
    ...
    ggsave.A4(
        filename="./report.ver2/210215-sixth-dataset/201221-fifth-phenotype-collection/total.samples/all.edits.venn.png",
        plot=.,
...
## A-to-G ratio, boxplot
{
    ...
    ggsave.A4(
        filename="./report.ver2/210215-sixth-dataset/201221-fifth-phenotype-collection/total.samples/all.edits.A.to.G.ratio.boxplot.png",
        plot=.,
...
## Alu ratio, boxplot
{
    ...
    . + guides(color=guide_legend(nrow=3)) ->.;
    . + scale_y_continuous(limits=c(0, 100)) ->.;
    . + labs(x="", y="% edits on Alu", color="") ->.;
    ggsave.A4(
        filename="./report.ver2/210215-sixth-dataset/201221-fifth-phenotype-collection/total.samples/all.edits.Alu.ratio.boxplot.png",
        plot=.,
        width.r=0.45, height.r=0.15
    )       
}
