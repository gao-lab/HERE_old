...

{
    ...
    . + labs(x="", y="# RE-matching edits\ncompletely lost in this group", fill="") ->.;
    . + scale_y_continuous(breaks=c(0, 15, 30, 45)) -> .;
    ## save image
    ggsave.A4(
        filename="./report.ver2/210215-sixth-dataset/201221-fifth-phenotype-collection/total.samples/disease.or.old.mother.embryo.lost.RE.count.barplot.png",
        plot=.,
...

{
    ...
    . + labs(x="Functions shared across\n>= 4 genes targeted by\nAG-lost RE-matching edits", y="BH-adjusted p-value   ") ->.;
    ## save image
    ggsave.A4(
        filename="./report.ver2/210215-sixth-dataset/201221-fifth-phenotype-collection/total.samples/disease.or.old.mother.embryo.lost.RE.gene.GO.gene.count.ge.4.barplot.png",
        plot=.,
